                ...
                > 
                    <div className='aspect-video flex items-center justify-center'> 
                        <Avatar className='z-40'>
                            <Image src={avatar1} alt='avatar image' className='rounded-full'/>
                        </Avatar>
                          <Avatar className='-ml-6 border-indigo-500 z-30'>
                            <Image src={avatar2} alt='avatar image' className='rounded-full'/>
                        </Avatar>
                          <Avatar className='-ml-6 border-amber-500 z-20'> 
                            <Image src={avatar3} alt='avatar image' className='rounded-full'/>
                        </Avatar>
                        <Avatar className='-ml-6 border-transparent '>
                            <div className='size-full bg-neutral-700 rounded-full inline-flex items-center justify-center gap-1'>
                                {Array.from({ length:3 }).map((_, id)=>(
                                    <span className='size-1.5 rounded-full bg-white inline-flex' key={id}></span>
                                ))}
