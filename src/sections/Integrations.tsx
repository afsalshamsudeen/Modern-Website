...
import { IntegrationsData } from "@/data/Integratiions";
    ...
    return <section className="py-24 overflow-hidden">
        <div className="container">
            <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                <div>
                    <Tags>{IntegrationsData.tag}</Tags>
                    <h2 className="text-6xl font-medium mt-6">Plays well with <span className="text-lime-400">others</span></h2>
                    <p className="text-white/50 mt-4 text-lg">{IntegrationsData.description}</p>
                </div>
                <div>

                    <div className="h-[400px] lg:h-[800] mt-8 lg:mt-0 grid md:grid-cols-2 gap-4  overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
